<div class="table-data">
    <div class="relative overflow-x-auto sm:rounded-lg mt-1 space-y-6">
        <table id="my-table" class="w-full font-arial text-sm text-white-200 dark:text-white-200 text-center">
            <thead
                    ...
                    <tr
                        ...
                        <td>
                            <div class="inline-flex gap-2">
                                <a href="{{ route('userdata.show', $userdata) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    View
                                ...
                                <p>|</p>
                                <a href="{{route('userdata.edit', $userdata)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                    Edit
                                ...
                                <form id="userdata-deleteform" action="{{ route('userdata.destroy',$userdata) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <button id="userdata-delete" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                        Delete
