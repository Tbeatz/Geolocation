<div id="confirm_modal" tabindex="-1" class="fixed hidden inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
    <div class="relative top-40 mx-auto p-5 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow-l">
            <button type="button" id="no_icon" class="absolute top-3 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-700 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center">
            ...
            <div class="p-6 text-center">
                ...
                <button id="yes_btn" type="button" class="text-white font-arial bg-greenprimary hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                    Yes, I'm sure
                </button>
                <button id="no_btn" type="button" class="text-gray-500 font-arial bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-400 text-sm px-5 py-2.5 hover:text-gray-700 focus:z-10">No, cancel</button>
            </div>
        </div>
    </div>
</div>
