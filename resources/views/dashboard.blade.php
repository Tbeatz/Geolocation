                            ...
                            <div class="m-auto w-3/4">
                                ...
                                <div class="flex flex-row mt-2">
                                    <div class="w-full">
                                        ...
                                        <select style="width: 98%; font-family:arial;" id="permit_type_id" name="permit_type_id" class="border border-gray-300 rounded-md block p-2 dark:bg-gray-100 dark:border-gray-200 dark:placeholder-gray-400 dark:text-gray-900 dark:focus:ring-lime-600 dark:focus:border-blue-500" required>
                                    ...
                                    <div class="w-full">
                                        ...
                                        <select style="width: 98%; font-family:arial;" name="form_of_invest_id" id="form_of_invest_id" class="border border-gray-300 text-gray-200 rounded-md block p-2 dark:bg-gray-100 dark:border-gray-200 dark:placeholder-gray-200 dark:text-gray-900 dark:focus:ring-lime-600 dark:focus:border-blue-200" required>
