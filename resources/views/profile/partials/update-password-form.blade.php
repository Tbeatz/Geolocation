    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="flex">
                ...
                <input type="password" id="current_password" name="current_password" class="mt-1 text-sm block w-full dark:border-gray-300 dark:bg-white dark:text-gray-900 dark:focus:border-green-400 focus:ring-green-300 dark:focus:ring-lime-600 rounded-md shadow-sm font-arial" required autofocus autocomplete="current-password" />
            </div>
        ...
        <div>
            ...
            <div class="flex">
                ...
                <input type="password" id="password" name="password" class="mt-1 block w-full text-sm dark:border-gray-300 font-arial dark:bg-white dark:text-gray-900 dark:focus:border-green-400 focus:ring-green-300 dark:focus:ring-lime-600 rounded-md shadow-sm" required autofocus autocomplete="new-password" />
            </div>
        ...
        <div>
            ...
            <div class="flex">
                ...
                <input type="password" id="password_confirmation" name="password_confirmation" class="mt-1 text-sm block w-full dark:border-gray-300 font-arial dark:bg-white dark:text-gray-900 dark:focus:border-green-400 focus:ring-green-300 dark:focus:ring-lime-600 rounded-md shadow-sm" required autofocus autocomplete="new-password" />
            </div>
