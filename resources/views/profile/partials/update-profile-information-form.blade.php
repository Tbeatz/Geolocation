    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <div class="flex">
                ...
                <input type="text" id="email" name="email" class="mt-1 block w-full text-sm font-arial dark:border-gray-300 dark:bg-white dark:text-gray-900 dark:focus:border-green-400 focus:ring-green-300 dark:focus:ring-lime-600 rounded-md shadow-sm" value="{{old('name', $user->email)}}" required autofocus  />
            </div>
