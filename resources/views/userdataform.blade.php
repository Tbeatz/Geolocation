            ...
            <div class="p-4 sm:p-8 bg-neutral-200 shadow sm:rounded-lg border-2 border-neutral-300">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section>
                        ...
                        @endif
                        <form method="post" action="{{ route('userdata.store') }}" class="p-4 sm:p-8 bg-green-600 shadow sm:rounded-lg border-2 border-gray-300">
                            @csrf
                            <div>
                            ...
                            <div class="m-auto w-3/4">
                                ...
                                <div class="flex items-center gap-2 mt-5">
                                    ...
                                    <a href="{{route('userdata.index')}}" class="font-arial text-semibold uppercase items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-2 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Back</a>
                                </div>
                            </div>
                        </form>
                    </section>
