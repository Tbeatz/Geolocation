    ...
    <x-slot name="header">
        ...
        <div>
            ...
            <div id="userdataedit-msg" class="flex p-4 text-green-800 rounded-lg bg-green-50 dark:bg-green-50 dark:text-green-800" role="alert">
                ...
                <button type="button" id="userdataedit-close" class="ml-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex h-8 w-8 dark:bg-green-50 dark:text-green-500 dark:hover:bg-green-200" data-dismiss-target="#dash-msg" aria-label="Close">
