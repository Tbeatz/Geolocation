                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <section>
                        ...
                        <div class="relative w-60">
                            ...
                            <button type="submit" onclick="searchTable1()" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-green-700 hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-700">
