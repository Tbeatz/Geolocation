                    ...
                    <section>
                        ...
                        <div class="relative w-72">
                            <form>
                                ...
                                <button type="submit" id="usersSearch" class="absolute top-0 right-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-r-lg border border-greenprimary hover:bg-blue-800 focus:ring-1 focus:outline-none focus:ring-green-300 dark:bg-greenprimary dark:hover:bg-green-700 dark:focus:ring-green-700">
